...
\item setting the linear and angular velocity by using two Sliders-\/directly controlling the robot movements by using 5 Buttons\+: forward, turn right, backward, turn left, stop 
